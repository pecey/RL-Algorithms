...
def vtrace_target(actor_action_distribution, learner_action_distribution, actions, rewards, values, discounts,
                  bootstrap_value,
    ...
    with T.no_grad():
        ...
        vs = [np.sum([values[t], v_trace_target_at_time_t(t, trajectory_length, discounts, clipped_c, deltas)]) for t in
